...
| Name              | Price     | Notes     |
|-------------------|-----------|-----------|
| Sketch            | $30       | Uncolored drawing. Rough, sketchy lines.
| Sketch [Anim]     | $60       | Uncolored animation. Animated at 24fps on 2's and 3's.
...
| Name                    | Price       | Notes     |
|-------------------------|-------------|-----------|
| Detailed Background     | +$15        | Add detailed objects and scenery to the background.
| Rough Colors [Sketch]   | +$15        | Add quick, rough colors to a Sketch / Sketch Anim.
| Per. Extra Scene [Anim] | +$(Base / 2)| Add additional camera angles or loops to an animation (max: 3).
...
- ❌ Anything illegal {{< spoiler txt="(Underaged Characters, Feral, Guro, etc.)" >}}
